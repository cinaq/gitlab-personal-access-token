...
def create_pat(conn, user_id, user_scopes, token_digest):
    with conn.cursor() as cursor:
        cursor.execute("""INSERT INTO personal_access_tokens (impersonation, scopes, revoked, user_id, token_digest) VALUES  (%s, %s, %s, %s, %s)""", (False, user_scopes, False, user_id, token_digest))
